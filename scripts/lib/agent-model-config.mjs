 ...
 *
 * Reads `agents.<name>.model` from the OMQ user/project config (the same
...
function getConfigPaths(cwd) {
  return {
    user: join(getConfigDir(), 'qoder-omq', 'config.jsonc'),
    project: join(cwd || process.cwd(), '.claude', 'omq.jsonc'),
  };
}
 ...
 * Returns the raw configured model string (e.g. "medium", "qwen-max"),
