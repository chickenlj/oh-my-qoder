...
# Check commands/omq.md updated
if grep -q "qa-tester" commands/omq.md 2>/dev/null; then
    log_pass "qa-tester in commands/omq.md"
else
    log_fail "qa-tester NOT in commands/omq.md"
fi
