 ...
 *   OPENCLAW_DISCORD_CHANNEL - Discord channel ID for delivery (default: #omq-dev)
 */
...
function buildAgentMessage(payload) {
  ...
  parts.push("");
  parts.push("Please acknowledge this OMQ session event and provide a brief status update to #omq-dev.");
