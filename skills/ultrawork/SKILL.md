...
<Tool_Usage>
- Use `Agent(subagent_type="oh-my-qoder:executor", model="low", ...)` for simple changes
- Use `Agent(subagent_type="oh-my-qoder:executor", model="medium", ...)` for standard work
- Use `Agent(subagent_type="oh-my-qoder:executor", model="high", ...)` for complex work
...
```
Agent(subagent_type="oh-my-qoder:executor", model="low", prompt="Add missing type export for Config interface")
Agent(subagent_type="oh-my-qoder:executor", model="medium", prompt="Implement the /api/users endpoint with validation")
Agent(subagent_type="oh-my-qoder:executor", model="medium", prompt="Add integration tests for the auth middleware")
```
...
```
Agent(subagent_type="oh-my-qoder:executor", model="medium", prompt="npm install && npm run build", run_in_background=true)
Agent(subagent_type="oh-my-qoder:executor", model="low", prompt="Update the README with new API endpoints")
```
...
```
Agent(subagent_type="oh-my-qoder:executor", model="high", prompt="Add a missing semicolon")
```
