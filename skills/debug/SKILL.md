---
name: debug
description: Diagnose the current OMQ session or repo state using logs, traces, state, and focused reproduction
---

# Debug

Use this skill when the user wants help diagnosing a current OMQ/Claude-Code session problem, workflow breakage, or confusing runtime behavior.
