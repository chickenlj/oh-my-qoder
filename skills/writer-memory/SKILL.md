...
- **Characters**: Emotional arcs, attitudes, dialogue tone, speech levels
- **World**: Settings, rules, atmosphere, constraints
- **Relationships**: Character dynamics and evolution over time
- **Scenes**: Cut composition, narration tone, emotional tags
- **Themes**: Emotional themes, authorial intent
...
| Command | Action |
|---------|--------|
| `/oh-my-qoder:writer-memory init <project-name>` | Initialize new project memory |
| `/oh-my-qoder:writer-memory status` | Show memory overview (character count, scene count, etc) |
| `/oh-my-qoder:writer-memory char add <name>` | Add new character |
| `/oh-my-qoder:writer-memory char <name>` | View character details |
| `/oh-my-qoder:writer-memory char update <name> <field> <value>` | Update character field |
| `/oh-my-qoder:writer-memory char list` | List all characters |
| `/oh-my-qoder:writer-memory rel add <char1> <char2> <type>` | Add relationship |
| `/oh-my-qoder:writer-memory rel <char1> <char2>` | View relationship |
| `/oh-my-qoder:writer-memory rel update <char1> <char2> <event>` | Add relationship event |
| `/oh-my-qoder:writer-memory scene add <title>` | Add new scene |
| `/oh-my-qoder:writer-memory scene <id>` | View scene details |
| `/oh-my-qoder:writer-memory scene list` | List all scenes |
| `/oh-my-qoder:writer-memory theme add <name>` | Add theme |
| `/oh-my-qoder:writer-memory world set <field> <value>` | Set world attribute |
| `/oh-my-qoder:writer-memory query <question>` | Query memory naturally (Korean supported) |
| `/oh-my-qoder:writer-memory validate <character> <dialogue>` | Check if dialogue matches character tone |
| `/oh-my-qoder:writer-memory synopsis` | Generate emotion-focused synopsis |
| `/oh-my-qoder:writer-memory export` | Export full memory as readable markdown |
| `/oh-my-qoder:writer-memory backup` | Create manual backup |
...
### With OMQ Notepad System
Writer Memory integrates with `.omq/notepad.md`:
...
```
Agent(subagent_type="oh-my-qoder:architect",
     model="high",
