...
```
/oh-my-qoder:sciomq <goal>                    # Standard research with user checkpoints
/oh-my-qoder:sciomq AUTO: <goal>              # Fully autonomous until complete
/oh-my-qoder:sciomq status                    # Check current research session status
/oh-my-qoder:sciomq resume                    # Resume interrupted research session
/oh-my-qoder:sciomq list                      # List all research sessions
/oh-my-qoder:sciomq report <session-id>       # Generate report for session
```

### Quick Examples

```
/oh-my-qoder:sciomq What are the performance characteristics of different sorting algorithms?
/oh-my-qoder:sciomq AUTO: Analyze authentication patterns in this codebase
/oh-my-qoder:sciomq How does the error handling work across the API layer?
```
...
Agent(subagent_type="oh-my-qoder:scientist", model="low", prompt="[RESEARCH_STAGE:1] Investigate...")

// Stage 2 - Standard analysis
Agent(subagent_type="oh-my-qoder:scientist", model="medium", prompt="[RESEARCH_STAGE:2] Analyze...")

// Stage 3 - Complex reasoning
Agent(subagent_type="oh-my-qoder:scientist", model="high", prompt="[RESEARCH_STAGE:3] Deep analysis of...")
```
...
Agent(subagent_type="oh-my-qoder:scientist", model="medium", prompt="
...
4. **Cancellation:** `/oh-my-qoder:cancel` or "stop", "cancel"

### AUTO Mode Example

```
/oh-my-qoder:sciomq AUTO: Comprehensive security analysis of the authentication system
...
Agent(subagent_type="oh-my-qoder:scientist", model="low", prompt="[STAGE:1] Analyze src/api/...")
Agent(subagent_type="oh-my-qoder:scientist", model="low", prompt="[STAGE:2] Analyze src/utils/...")
Agent(subagent_type="oh-my-qoder:scientist", model="low", prompt="[STAGE:3] Analyze src/components/...")
```
...
Agent(subagent_type="oh-my-qoder:scientist", model="medium", prompt="[HYPOTHESIS:A] Test if caching improves...")
Agent(subagent_type="oh-my-qoder:scientist", model="medium", prompt="[HYPOTHESIS:B] Test if batching reduces...")
Agent(subagent_type="oh-my-qoder:scientist", model="medium", prompt="[HYPOTHESIS:C] Test if lazy loading helps...")
```
...
Agent(subagent_type="oh-my-qoder:scientist", model="high", prompt="
[CROSS_VALIDATION]
...
| Command | Action |
|---------|--------|
| `/oh-my-qoder:sciomq status` | Show current session progress |
| `/oh-my-qoder:sciomq resume` | Resume most recent interrupted session |
| `/oh-my-qoder:sciomq resume <session-id>` | Resume specific session |
| `/oh-my-qoder:sciomq list` | List all sessions with status |
| `/oh-my-qoder:sciomq report <session-id>` | Generate/regenerate report |
| `/oh-my-qoder:sciomq cancel` | Cancel current session (preserves state) |
...
Progress is preserved in `.omq/research/{session-id}/` for resume.
