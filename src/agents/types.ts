 ...
 * This enables OMQ to build delegation tables automatically
 */
...
/**
 * Available agent descriptor for OMQ prompt building
 */
...
export function getDefaultModelForCategory(category: AgentCategory): ModelType {
  switch (category) {
    case 'exploration':
      return 'low'; // Fast, cheap
    case 'specialist':
      return 'medium'; // Balanced
    case 'advisor':
      return 'high'; // High quality reasoning
    case 'utility':
      return 'low'; // Fast, cheap
    case 'orchestration':
      return 'medium'; // Balanced
