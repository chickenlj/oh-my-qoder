 ...
 * 4. omqSystemPrompt for the main orchestrator
 */
...
/**
 * Debugger Agent - Root-Cause Analysis & Debugging (medium-tier)
 */
export const debuggerAgent: AgentConfig = {
  name: 'debugger',
  description: 'Root-cause analysis, regression isolation, failure diagnosis (medium-tier).',
...
/**
 * Verifier Agent - Completion Evidence & Test Validation (medium-tier)
 */
export const verifierAgent: AgentConfig = {
  name: 'verifier',
  description: 'Completion evidence, claim validation, test adequacy (medium-tier).',
...
/**
 * Test-Engineer Agent - Test Strategy & Coverage (medium-tier)
 * Replaces: tdd-guide agent
 */
export const testEngineerAgent: AgentConfig = {
  name: 'test-engineer',
  description: 'Test strategy, coverage, flaky test hardening (medium-tier).',
...
/**
 * Security-Reviewer Agent - Security Vulnerability Detection (medium-tier)
 */
export const securityReviewerAgent: AgentConfig = {
  name: 'security-reviewer',
  description: 'Security vulnerability detection specialist (medium-tier). Use for security audits and OWASP detection.',
...
/**
 * Code-Reviewer Agent - Expert Code Review (high-tier)
 */
export const codeReviewerAgent: AgentConfig = {
  name: 'code-reviewer',
  description: 'Expert code review specialist (high-tier). Use for comprehensive code quality review.',
...
/**
 * Git-Master Agent - Git Operations Expert (medium-tier)
 */
...
/**
 * Code-Simplifier Agent - Code Simplification & Refactoring (high-tier)
 */
export const codeSimplifierAgent: AgentConfig = {
  name: 'code-simplifier',
  description: 'Simplifies and refines code for clarity, consistency, and maintainability (high-tier).',
...
/**
 * OMQ System Prompt - The main orchestrator
 */
export const omqSystemPrompt = `You are the relentless orchestrator of a multi-agent development system.
