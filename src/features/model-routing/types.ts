 ...
 * sub-agent tasks to appropriate models (qwen-max/qwen-plus/qwen-turbo)
...
/**
 * Model tier mapping to actual Qwen models.
 *
 * Reads from environment variables (OMQ_MODEL_HIGH, OMQ_MODEL_MEDIUM,
 * OMQ_MODEL_LOW) with built-in fallbacks. User/project config overrides
