...
export interface PaneAnalysisResult {
  /** Whether this pane appears to have Qoder CLI */
...
export interface DaemonConfig {
  ...
  verbose?: boolean;
  /** State file path (default: XDG-aware global OMQ state path) */
  stateFilePath?: string;
  /** PID file path (default: XDG-aware global OMQ state path) */
  pidFilePath?: string;
  /** Log file path (default: XDG-aware global OMQ state path) */
  logFilePath?: string;
}
