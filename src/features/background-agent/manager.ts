 ...
 *
 * Manages background tasks for the OMQ system.
 * This is a simplified version that tracks tasks launched via Qoder CLI's
...
const BACKGROUND_TASKS_DIR = join(getQoderConfigDir(), '.omq', 'background-tasks');
