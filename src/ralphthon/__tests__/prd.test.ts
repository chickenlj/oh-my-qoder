...
describe("Ralphthon PRD", () => {
  ...
  describe("readRalphthonPrd", () => {
    ...
    it("should read a valid PRD from .omq directory", () => {
    ...
    it("should return null for invalid JSON", () => {
      ...
      writeFileSync(
        join(testDir, ".omq", "ralphthon-prd.json"),
        "invalid json",
      );
      expect(readRalphthonPrd(testDir)).toBeNull();
    });
  ...
  describe("writeRalphthonPrd", () => {
    it("should write PRD to .omq directory", () => {
      const prd = createTestPrd();
    ...
    it("should create .omq directory if missing", () => {
