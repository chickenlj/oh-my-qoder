/**
 * OMQ HUD - Output Sanitizer
 *
 * Sanitizes HUD output to prevent terminal rendering corruption
 * when Qoder CLI's Ink renderer is concurrently updating the display.
 *
 ...
 * with Qoder CLI's terminal cursor positioning during active rendering.
 *
