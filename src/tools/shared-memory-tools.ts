 ...
 * Config gate: agents.sharedMemory.enabled in ~/.qoder/.omq-config.json
 *
...
const DISABLED_MSG = `Shared memory is disabled. Set agents.sharedMemory.enabled = true in ${getQoderConfigDir()}/.omq-config.json to enable.`;
