 ...
 * Skills Tools
 *
 * MCP tools for loading and listing OMQ learned skills
 * from local (.omq/skills/) and global (~/.omq/skills/) directories.
 */
...
// Tool 1: load_omq_skills_local
export const loadLocalTool = {
  name: 'load_omq_skills_local',
  description: 'Load and list skills from the project-local .omq/skills/ directory. Returns skill metadata (id, name, description, triggers, tags) for all discovered project-scoped skills.',
...
// Tool 2: load_omq_skills_global
export const loadGlobalTool = {
  name: 'load_omq_skills_global',
  description: 'Load and list skills from global user directories (~/.omq/skills/ and [$QODER_CONFIG_DIR|~/.qoder]/skills/omq-learned/). Returns skill metadata for all discovered user-scoped skills.',
...
// Tool 3: list_omq_skills
export const listSkillsTool = {
  name: 'list_omq_skills',
...
/** All skills tools for registration in omq-tools-server */
