 ...
 *
 * Reads .omq/plans/ directory for PRD and test-spec files,
...
function getPlansDirCandidates(cwd: string): string[] {
  return [join(getOmqRoot(cwd), "plans"), join(cwd, ".omx", "plans")];
}
...
/**
 * Read planning artifacts from .omq/.omx plans directories.
