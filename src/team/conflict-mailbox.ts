...
//
// Formats and delivers merge/rebase conflict notifications for omq-teams CLI workers.
//
// NOTE: Markdown inbox is canonical for omq-teams CLI; JSONL is for native /team MCP workers
// (out of scope here). Worker inbox: .omq/state/team/{team}/workers/{worker}/inbox.md.
// Leader inbox: .omq/state/team/{team}/leader/inbox.md (see leader-inbox.ts).
//
