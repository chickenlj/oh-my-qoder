 ...
 *
 * Handles snake_case -> camelCase field mapping for Qoder CLI hook inputs.
 * Qoder CLI sends snake_case fields: tool_name, tool_input, tool_response,
...
const HookInputSchema = z.object({
  // snake_case fields from Qoder CLI
...
/**
 * Raw hook input as received from Qoder CLI (snake_case fields)
 */
...
const KNOWN_FIELDS = new Set([
  ...
  // Common extra fields from Qoder CLI
...
/**
 * Normalize hook input from Qoder CLI's snake_case format to the
