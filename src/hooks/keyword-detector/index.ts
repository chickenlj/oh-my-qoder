...
const KEYWORD_PATTERNS: Record<KeywordType, RegExp> = {
  cancel: /\b(cancelomq|stopomq)\b/i,
 ...
 * not rerouted into the OMQ skill.
 */
...
export interface ExplicitWorkflowSlashInvocation {
  /** Canonical workflow skill name (lowercase, no `oh-my-qoder:` prefix). */
 ...
 *
 * Recognizes `/<skill>`, `/omq:<skill>`, and `/oh-my-qoder:<skill>` for
...
export function detectKeywordsWithType(
  ...
  // robust to surrounding whitespace, namespace prefixes (`/omq:`,
