 ...
 *
 * Opt-in via global OMQ config.json (XDG-aware on Linux/Unix, legacy ~/.omq fallback)
...
/**
 * Read the global OMQ config from the XDG-aware location, with legacy
 * ~/.omq/config.json fallback for backward compatibility.
 * Returns null if the file does not exist or cannot be parsed.
 */
export function readOmqConfig(): OmqGlobalConfig | null {
