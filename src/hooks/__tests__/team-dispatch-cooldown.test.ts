...
beforeEach(async () => {
  root = await mkdtemp(join(tmpdir(), 'omq-dispatch-cooldown-'));
  ...
  process.env.OMQ_TEAM_DISPATCH_ISSUE_COOLDOWN_MS = '600000';
  process.env.OMQ_TEAM_DISPATCH_TRIGGER_COOLDOWN_MS = '600000';
});
