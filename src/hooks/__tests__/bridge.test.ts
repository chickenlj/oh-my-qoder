...
describe('processHook - Environment Kill-Switches', () => {
  ...
  describe('DISABLE_OMQ flag', () => {
    it('should return continue:true when DISABLE_OMQ=1', async () => {
    ...
    it('should return continue:true when DISABLE_OMQ=true (string)', async () => {
    ...
    it('should process normally when DISABLE_OMQ is not set', async () => {
      const input: HookInput = {
        sessionId: 'test-session',
        prompt: 'hello world',
        directory: '/tmp/test'
  ...
  describe('OMQ_SKIP_HOOKS flag', () => {
    it('should skip single hook type when specified', async () => {
      process.env.OMQ_SKIP_HOOKS = 'pre-tool-use';
    ...
    it('should skip multiple hook types when comma-separated', async () => {
      process.env.OMQ_SKIP_HOOKS = 'pre-tool-use,persistent-mode';
    ...
    it('should handle whitespace in OMQ_SKIP_HOOKS', async () => {
      process.env.OMQ_SKIP_HOOKS = ' pre-tool-use , persistent-mode ';
    ...
    it('should process normally when OMQ_SKIP_HOOKS is empty', async () => {
  ...
  describe('Combined flags', () => {
    it('should respect DISABLE_OMQ even if OMQ_SKIP_HOOKS is set', async () => {
      process.env.DISABLE_OMQ = '1';
  ...
  describe('Performance', () => {
    ...
    it('should have minimal overhead when DISABLE_OMQ=1', async () => {
      process.env.DISABLE_OMQ = '1';
  ...
  describe('All hook types', () => {
    ...
    it('should disable all hook types when DISABLE_OMQ=1', async () => {
      process.env.DISABLE_OMQ = '1';
