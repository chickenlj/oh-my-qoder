 ...
 * ```markdown
 * # Notepad
 * <!-- Auto-managed by OMQ. Manual edits preserved in MANUAL section. -->
 *
 * ## Priority Context
...
/**
 * Get the path to notepad.md in .omq subdirectory
 */
export function getNotepadPath(directory: string): string {
  return join(getOmqRoot(directory), NOTEPAD_FILENAME);
}
