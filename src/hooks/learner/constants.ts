...
export const USER_SKILLS_DIR = join(getQoderConfigDir(), 'skills', 'omq-learned');

/** Global skills directory (new preferred location: ~/.omq/skills) */
...
/** Debug mode enabled */
export const DEBUG_ENABLED = process.env.OMQ_DEBUG === '1';
