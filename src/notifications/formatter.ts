...
/** Lines starting with these characters are OMQ UI chrome, not output. */
const UI_CHROME_RE = /^[●⎿✻·◼]/;

/** Matches the "ctrl+o to expand" hint injected by OMQ. */
 ...
 * - Drops lines starting with OMQ chrome characters (●, ⎿, ✻, ·, ◼)
