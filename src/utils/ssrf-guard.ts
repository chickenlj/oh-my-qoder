...
/**
 * Validate DASHSCOPE_BASE_URL for safe usage
 * This is a convenience function that also enforces HTTPS preference
 */
export function validateDashScopeBaseUrl(urlString: string): SSRFValidationResult {
  ...
  if (parsed.protocol === 'http:') {
    console.warn('[SSRF Guard] Warning: Using HTTP instead of HTTPS for DASHSCOPE_BASE_URL');
  }

  return { allowed: true };
}

/** @deprecated Use validateDashScopeBaseUrl instead */
export const validateAnthropicBaseUrl = validateDashScopeBaseUrl;
