...
describe('Skill Finder', () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(projectRoot, '.omq', 'skills'), { recursive: true });
  });
  ...
  it('should find project-level skills', () => {
    const skillPath = join(projectRoot, '.omq', 'skills', 'test-skill.md');
  ...
  it('should prioritize project skills over user skills', () => {
    ...
    const projectSkillPath = join(projectRoot, '.omq', 'skills', 'skill.md');
  ...
  it('should populate sourceDir for project skills', () => {
    ...
    expect(projectCandidate!.sourceDir).toBe(join(projectRoot, '.omq', 'skills'));
  });
  ...
  it('should respect depth limit for deep directories', () => {
    ...
    let deepDir = join(projectRoot, '.omq', 'skills');
    for (let i = 0; i < 15; i++) {
  ...
  it('should construct PROJECT_SKILLS_SUBDIR with path.join', () => {
    expect(PROJECT_SKILLS_SUBDIR).toBe(join('.omq', 'skills'));
  });
});
