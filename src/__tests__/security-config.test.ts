...
describe('security-config', () => {
  ...
  describe('defaults (no env var)', () => {
    ...
    it('secure defaults for safe features, opt-in for others', () => {
      ...
      // Auto-update controlled by OMQConfig; security-config only overrides in strict
  ...
  describe('OMQ_SECURITY with non-strict value', () => {
    beforeEach(() => {
      process.env.OMQ_SECURITY = 'relaxed';
      clearSecurityConfigCache();
    });
