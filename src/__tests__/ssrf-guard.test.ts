...
describe('SSRF Guard', () => {
  describe('validateUrlForSSRF', () => {
    ...
    describe('allows valid URLs', () => {
      it('allows https://api.dashscope.aliyuncs.com', () => {
        expect(validateUrlForSSRF('https://api.dashscope.aliyuncs.com/v1').allowed).toBe(true);
      });
  ...
  describe('validateAnthropicBaseUrl', () => {
    ...
    it('allows valid external URLs', () => {
      expect(validateAnthropicBaseUrl('https://api.dashscope.aliyuncs.com').allowed).toBe(true);
    });
  });
});
