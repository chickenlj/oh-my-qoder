...
export const FEATURED_CONTRIBUTORS_START_MARKER = '<!-- OMQ:FEATURED-CONTRIBUTORS:START -->';
export const FEATURED_CONTRIBUTORS_END_MARKER = '<!-- OMQ:FEATURED-CONTRIBUTORS:END -->';
...
function getGitHubHeaders(): Record<string, string> {
  ...
  return {
    ...
    'User-Agent': 'oh-my-qoder-featured-contributors-generator',
...
export function renderFeaturedContributorsSection(
  ...
  const lines = [
    ...
    '',
    `Top personal non-fork, non-archived repos from all-time OMQ contributors (${minStars}+ GitHub stars).`,
    '',
  ];
