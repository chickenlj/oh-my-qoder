...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.omq/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.omq/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      When a second opinion would improve quality, spawn a Qoder Task agent:
      - Use `Task(subagent_type="oh-my-qoder:architect", ...)` for architectural cross-checks
